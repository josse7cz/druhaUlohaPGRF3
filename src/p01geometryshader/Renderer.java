...
import static org.lwjgl.opengles.GLES32.GL_LINE_STRIP_ADJACENCY;
...
public class Renderer extends AbstractRenderer{
	...
	private int setSides,locTime,viewLocation, projectionLocation, modelLocation,uLevel,uRadius,uColor,normalMatrix;
	...
	void initBuffers() {
        ...
        uLevel=glGetUniformLocation(shaderProgram,"uLevel");
        uRadius=glGetUniformLocation(shaderProgram,"uRradius");
	...
	public void init() {
		...
		buffers=TriangleFactory.generateTriangle(10   , 10);
}
	...
	public void display() {
        ...
        glUniform3i(uLevel,0,0,1);
        glUniform3f(uRadius,0.5f,1.0f,5.0f);
        glUniform4f(uColor,1.f,0.5f,0.15f,1.0f);
        glUniformMatrix3fv(normalMatrix,true,camera.getViewMatrix().inverse().get().floatArray());
